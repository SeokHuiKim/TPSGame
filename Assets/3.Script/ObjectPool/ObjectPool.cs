...
public class ObjectPool : Singleton<ObjectPool>
{
    ...
    public bool EffectPushToPool(string itemName, GameObject item, float lifeTime, Transform parent = null)
    {
        PooledObject pool = GetPoolItem(itemName);
        if (pool == null)
            return false;
    ...
    PooledObject GetPoolItem(string ItemName)
    {
        ...
        Debug.LogWarning("There`s no matched pool list." + ItemName);
        return null;
    }
}
